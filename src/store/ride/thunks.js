...
import { setAllRides, postRides, setRideDetails } from "./slice";
//get all rides
...
export const fetchRideDetails = (id) => async (dispatch, getState) => {
  try {
    dispatch(appLoading());
    const response = await axios.get(`${apiUrl}/rides/${id}`);
    // console.log("Response ride details  thunk", response.data);
